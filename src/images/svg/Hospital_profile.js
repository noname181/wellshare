...
function Hospital_profile({ width, height, color }) {
  ...
  <g id="Group_6701" data-name="Group 6701" transform="translate(159.471 -929)">
    <circle id="Ellipse_666" data-name="Ellipse 666" cx="3.821" cy="3.821" r="3.821" transform="translate(-155.395 929)" fill=${color}/>
    <g id="Group_6697" data-name="Group 6697" transform="translate(-159.471 937.697)">
      <path id="Path_18443" data-name="Path 18443" d="M-143.3,1068.842a8.084,8.084,0,0,0-8.083-7.981,8.084,8.084,0,0,0-8.083,7.981Z" transform="translate(159.471 -1060.861)" fill=${color}/>
    </g>
  </g>
</svg>
