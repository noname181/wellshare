...
function Hospital_profileIcon7({ width, height, color }) {
  const xml = `
  <svg xmlns="http://www.w3.org/2000/svg" width="14.999" height="12.136" viewBox="0 0 14.999 12.136">
...
export default Hospital_profileIcon7;