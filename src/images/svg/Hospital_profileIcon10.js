...
function Hospital_profileIcon10({ width, height, color }) {
  const xml = `
  <svg xmlns="http://www.w3.org/2000/svg" width="13.929" height="14.733" viewBox="0 0 13.929 14.733">
...
export default Hospital_profileIcon10;